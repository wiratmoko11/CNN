...
class ConvModel():
    ...
    def init_model_1(self, x, w1, b1, w2, b2, w3, b3, w_output, b_output):
        print("Model 1")
        layer_0 = x
    ...
    def init_model_2(self, x, w1, b1, w2, b2, w3, b3, w_output, b_output):
        print("Model 2")
        layer_0 = x
    ...
    def init_model_3(self, x, w1, b1, w2, b2, w3, b3, w_output, b_output):
        print("Model 3")
        layer_0 = x
        layer_1 = self.utils.relu(conv2d(input=layer_0, filters=w1, border_mode=2) + b1.dimshuffle('x', 0, 'x', 'x'))
        layer_2 = pool.pool_2d(input=layer_1, ws=(2, 2), ignore_border=True)
